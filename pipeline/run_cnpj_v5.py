...
from pipeline.estoque.derivados_fiscais_v2 import build_aba_anual_v2, build_aba_mensal_v2, build_aba_periodos_v2
...
def run_gold_pipeline_v5(
    ...
    *,
    ...
    aba_mensal = build_aba_mensal_v2(mov_estoque)
    aba_anual = build_aba_anual_v2(mov_estoque)
    aba_periodos = build_aba_periodos_v2(mov_estoque)
