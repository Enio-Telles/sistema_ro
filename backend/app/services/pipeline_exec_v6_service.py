...
from backend.app.services.pipeline_service_v4 import run_and_persist_gold_pipeline_v4
...
def execute_pipeline_from_storage_v6(cnpj: str) -> dict:
    ...
    result = run_and_persist_gold_pipeline_v4(cnpj, **inputs)
    result["status"] = "ok"
    result["validation"] = validation
    result["pipeline_version"] = "gold_v4"
