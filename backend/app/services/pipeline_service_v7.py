...
from pipeline.persist_gold_v4 import persist_gold_outputs_v4
from pipeline.run_cnpj_v7 import run_gold_pipeline_v7


def run_and_persist_gold_pipeline_v7(
    cnpj: str,
    *,
    ...
    saved = persist_gold_outputs_v4(cnpj, outputs)
    return {
        "cnpj": cnpj,
        "saved": saved,
