...
from backend.app.services.pipeline_service_v5 import run_and_persist_gold_pipeline_v5
...
def execute_pipeline_from_storage_v7(cnpj: str) -> dict:
    ...
    result = run_and_persist_gold_pipeline_v5(cnpj, **inputs)
    result["status"] = "ok"
    result["validation"] = validation
    result["pipeline_version"] = "gold_v5"
