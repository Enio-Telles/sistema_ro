...
from backend.app.services.gold_pipeline_service_v7 import run_and_persist_gold_v7
...
def execute_gold_v7(cnpj: str) -> dict:
    ...
    result = run_and_persist_gold_v7(cnpj, **inputs)
    result["status"] = "ok"
    result["validation"] = validation
    result["pipeline_version"] = "gold_v7"
