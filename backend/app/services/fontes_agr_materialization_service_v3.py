...
def materialize_fontes_agr_v3(cnpj: str) -> dict:
    outputs = build_fontes_agr_v2(
    ...
    validations = {
        name: validate_fontes_agr_df(name, outputs[name])
        for name in ["c170_agr", "nfe_agr", "nfce_agr", "bloco_h_agr"]
    }
    ...
    return {
        ...
        "ok": all(v["ok"] for v in validations.values()),
        "agr_rows": {
