...
from backend.app.services.gold_pipeline_service_v6 import run_and_persist_gold_v6
...
def execute_gold_v6(cnpj: str) -> dict:
    ...
    result = run_and_persist_gold_v6(cnpj, **inputs)
    result["status"] = "ok"
