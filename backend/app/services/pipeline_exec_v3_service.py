...
from backend.app.services.pipeline_service_v2 import run_and_persist_gold_pipeline_v2
...
def execute_pipeline_from_storage_v3(cnpj: str) -> dict:
    ...
    result = run_and_persist_gold_pipeline_v2(cnpj, **inputs)
    result["status"] = "ok"
    result["validation"] = validation
    result["pipeline_version"] = "gold_v2"
    return result
