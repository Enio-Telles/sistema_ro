...
from backend.app.services.pipeline_service_v3 import run_and_persist_gold_pipeline_v3
...
def execute_pipeline_from_storage_v4(cnpj: str) -> dict:
    ...
    result = run_and_persist_gold_pipeline_v3(cnpj, **inputs)
    result["status"] = "ok"
    result["validation"] = validation
    result["pipeline_version"] = "gold_v3"
    return result
