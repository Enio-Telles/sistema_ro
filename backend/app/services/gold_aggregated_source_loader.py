...
def load_gold_inputs_preferring_aggregated_sources(cnpj: str) -> dict[str, pl.DataFrame | str | bool]:
    ...
    has_aggregated_sources = not c170_agr.is_empty() and not nfe_agr.is_empty()

    if has_aggregated_sources:
        ...
        return {
            ...
            "selected_items_source": "fontes_agr",
