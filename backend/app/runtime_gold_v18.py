...
app.include_router(layer_status_router, prefix="/api/gold18/layers", tags=["layers"])
app.include_router(mdc_contract_router, prefix="/api/gold18/mdc/contracts", tags=["mdc_contracts"])
app.include_router(mdc_materialize_router, prefix="/api/gold18/mdc", tags=["mdc_materialize"])
app.include_router(agregacao.router, prefix="/api/gold18/agregacao", tags=["agregacao"])
app.include_router(agregacao_materialize_router, prefix="/api/gold18/agregacao", tags=["agregacao_materialize"])
app.include_router(agregacao_review_router, prefix="/api/gold18/agregacao", tags=["agregacao_review"])
app.include_router(aggregated_sources_v2_router, prefix="/api/gold18/fontes-agr", tags=["fontes_agr"])
app.include_router(manual_map_router, prefix="/api/gold18/mapa-manual", tags=["manual_map"])
app.include_router(conversao.router, prefix="/api/gold18/conversao", tags=["conversao"])
app.include_router(estoque.router, prefix="/api/gold18/estoque", tags=["estoque"])
app.include_router(fisconforme.router, prefix="/api/gold18/fisconforme", tags=["fisconforme"])
app.include_router(pipeline_router, prefix="/api/gold18/pipeline", tags=["pipeline"])
app.include_router(conversao_quality_router, prefix="/api/gold18/conversao", tags=["conversao_quality"])
app.include_router(estoque_quality_router, prefix="/api/gold18/estoque", tags=["estoque_quality"])
app.include_router(references_router, prefix="/api/gold18/references", tags=["references"])
