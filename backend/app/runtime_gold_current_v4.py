...
app.include_router(health.router, prefix="/api/current-v4/health", tags=["health"])
app.include_router(status_router, prefix="/api/current-v4/status", tags=["status"])
app.include_router(runtime_recommendation_v2_router, prefix="/api/current-v4/runtime", tags=["runtime_recommendation"])
app.include_router(deprecation_surface_router, prefix="/api/current-v4/deprecations", tags=["deprecations"])
app.include_router(fisconforme_recommendation_v2_router, prefix="/api/current-v4/fisconforme-v2/recommendation", tags=["fisconforme_recommendation_v2"])
app.include_router(layer_status_router, prefix="/api/current-v4/layers", tags=["layers"])
app.include_router(mdc_contract_router, prefix="/api/current-v4/mdc/contracts", tags=["mdc_contracts"])
app.include_router(mdc_materialize_router, prefix="/api/current-v4/mdc", tags=["mdc_materialize"])
app.include_router(agregacao.router, prefix="/api/current-v4/agregacao", tags=["agregacao"])
app.include_router(agregacao_materialize_router, prefix="/api/current-v4/agregacao", tags=["agregacao_materialize"])
app.include_router(agregacao_review_router, prefix="/api/current-v4/agregacao", tags=["agregacao_review"])
app.include_router(aggregated_sources_v2_router, prefix="/api/current-v4/fontes-agr", tags=["fontes_agr"])
app.include_router(manual_map_router, prefix="/api/current-v4/mapa-manual", tags=["manual_map"])
app.include_router(conversao.router, prefix="/api/current-v4/conversao", tags=["conversao"])
app.include_router(conversao_quality_router, prefix="/api/current-v4/conversao", tags=["conversao_quality"])
app.include_router(estoque.router, prefix="/api/current-v4/estoque", tags=["estoque"])
app.include_router(estoque_quality_router, prefix="/api/current-v4/estoque", tags=["estoque_quality"])
app.include_router(gold_consistency_router, prefix="/api/current-v4/gold", tags=["gold_consistency"])
app.include_router(fisconforme.router, prefix="/api/current-v4/fisconforme", tags=["fisconforme_legacy"])
app.include_router(fisconforme_v2_router, prefix="/api/current-v4/fisconforme-v2", tags=["fisconforme_v2"])
app.include_router(fisconforme_refresh_v2_router, prefix="/api/current-v4/fisconforme-v2", tags=["fisconforme_refresh_v2"])
app.include_router(fisconforme_dsf_v2_router, prefix="/api/current-v4/fisconforme-v2", tags=["fisconforme_dsf_v2"])
app.include_router(fisconforme_notification_v3_router, prefix="/api/current-v4/fisconforme-v2", tags=["fisconforme_notification_v3"])
app.include_router(fisconforme_output_v2_router, prefix="/api/current-v4/fisconforme-v2", tags=["fisconforme_output_v2"])
app.include_router(pipeline_router, prefix="/api/current-v4/pipeline", tags=["pipeline"])
app.include_router(references_router, prefix="/api/current-v4/references", tags=["references"])
