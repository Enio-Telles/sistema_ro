...
app.include_router(health.router, prefix="/api/current-v2/health", tags=["health"])
app.include_router(status_router, prefix="/api/current-v2/status", tags=["status"])
app.include_router(runtime_recommendation_v2_router, prefix="/api/current-v2/runtime", tags=["runtime_recommendation"])
app.include_router(layer_status_router, prefix="/api/current-v2/layers", tags=["layers"])
app.include_router(mdc_contract_router, prefix="/api/current-v2/mdc/contracts", tags=["mdc_contracts"])
app.include_router(mdc_materialize_router, prefix="/api/current-v2/mdc", tags=["mdc_materialize"])
app.include_router(agregacao.router, prefix="/api/current-v2/agregacao", tags=["agregacao"])
app.include_router(agregacao_materialize_router, prefix="/api/current-v2/agregacao", tags=["agregacao_materialize"])
app.include_router(agregacao_review_router, prefix="/api/current-v2/agregacao", tags=["agregacao_review"])
app.include_router(aggregated_sources_v2_router, prefix="/api/current-v2/fontes-agr", tags=["fontes_agr"])
app.include_router(manual_map_router, prefix="/api/current-v2/mapa-manual", tags=["manual_map"])
app.include_router(conversao.router, prefix="/api/current-v2/conversao", tags=["conversao"])
app.include_router(conversao_quality_router, prefix="/api/current-v2/conversao", tags=["conversao_quality"])
app.include_router(estoque.router, prefix="/api/current-v2/estoque", tags=["estoque"])
