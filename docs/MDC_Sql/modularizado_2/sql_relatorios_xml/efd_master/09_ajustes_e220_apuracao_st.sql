...
-- Título no relatório: Ajustes E220 (Apuração ST)
-- Caminho no XML: EFD Master 2.0 > Ajustes E220 (Apuração ST)
-- Utilidade fiscal: Altíssima
-- Foco: Resumo de ajustes da apuração ST por tipo e código.
-- Uso sugerido: Permite rastrear créditos, outros débitos, deduções e controle extra-apuração especificamente na trilha de ST.
-- Riscos/Limites: É resumo; para ressarcimento, deve ser conciliado com C176/C197 e com a materialidade da entrada/saída.
