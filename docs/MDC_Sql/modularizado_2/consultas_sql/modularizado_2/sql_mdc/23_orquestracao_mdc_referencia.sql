...
CREATE VIEW mdc_diagnostico_conversao_unidade    AS <24_diagnostico_necessidade_conversao_unidade.sql>;
...
- Diagnóstico transversal de necessidade de conversão de unidade
*/
