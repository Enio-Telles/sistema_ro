/*
===============================================================================
SCRIPT: RESSARCIMENTO DE ICMS-ST - SAÍDA ANALÍTICA
-------------------------------------------------------------------------------
Objetivo:
- gerar uma visão detalhada item a item do confronto entre:
  1) SPED
  2) XML
  3) Fronteira
  4) Cálculo inferido
...
Saída:
- visão detalhada para conferência fiscal e análise item a item.
===============================================================================
*/
WITH
PARAMETROS AS (
