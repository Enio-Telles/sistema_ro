/*
===============================================================================
SCRIPT: RESSARCIMENTO DE ICMS-ST - SAÍDA RESUMO
-------------------------------------------------------------------------------
Objetivo:
- gerar uma visão resumida e gerencial do confronto entre:
  1) SPED
  2) XML
  3) Fronteira
  4) Cálculo inferido
...
Saída:
- visão resumida para triagem, painel, Excel e priorização de casos.
===============================================================================
*/
WITH
PARAMETROS AS (
