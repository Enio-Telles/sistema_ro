...
- `runtime_gold_v23`: acervo DSF e notificação modular inicial *(removido fisicamente do repositório)*
- `runtime_gold_v24`: template externo, imagens e ZIP em lote *(removido fisicamente do repositório)*
